RSpec.describe Peatio::FantasyGold::Wallet do
  let(:wallet) { Peatio::FantasyGold::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::FantasyGold::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::FantasyGold::Wallet::SUPPORTED_SETTINGS))
    end
  end
